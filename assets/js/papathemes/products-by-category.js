...
class ProductsByCategory {
    constructor({
        ...
        this.limit = limit;
        this.$parent = $parent;
        this.$scope = $('<div class="papathemes-productsByCategoryTabs-loading"></div>');
        this.$loadMore = $();
        this.$collapse = $();
        this.$loader = $();
    ...
    request() {
        ...
        const template = 'supermarket/products-by-category-sorting-tabs/section';
    ...
    loadProducts({
        ...
        const template = 'supermarket/products-by-category-sorting-tabs/products';
...
class ProductsByCategories {
    constructor($scope) {
        ...
        this.lazyOffset = window.supermarketThemeExtraConfig.pbcLazyOffset;
        this.loaded = false;
