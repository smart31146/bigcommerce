...
export default class Auth extends PageManager {
    ...
    onReady() {
        ...
        // this code will hide the address field(new custom field).because the field is also created in account form.we use account field.
        
        $("select[name*='FormField[2]'][data-label='Which best describes you or your organization?']").parent(".form-field--select").hide();
        
        $("form[data-create-account-form] .form-row").append($("select[name*='FormField[1]'][data-label='Which best describes you or your organization?']").parent(".form-field--select"));
